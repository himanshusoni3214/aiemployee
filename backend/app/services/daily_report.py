...
def render_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Drafts created: {_metric_value(report, 'drafts_generated', 'see dashboard')}",
        f"- Prospect emails sent: {_metric_value(report, 'real_emails_sent_today', _metric_value(report, 'emails_confirmed_sent_today', 0))}",
        f"- Replies received: not connected",
        f"- Meetings booked: not connected",
        "",
        "Leads found",
    ...
    lines.extend([
        ...
        f"- {report.get('next_recommended_action')}",
        "",
        "Outreach readiness",
